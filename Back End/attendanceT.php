    ...
    <header class="mainheader">
        ...
        <li><a href="profileT.php">Profile</a></li>
          ...
          <div class="attendance" style="text-align: center">
            ...
            <section>
               <select class="select" onChange="document.location.href=this.value" style="width: 30%;">
                  <option value="0">Please select a course to take attandance</option>
                  <?php
                  while($row = mysqli_fetch_array($run)){
                    ...
                    $section_id  = $row[4];
                  ?>
                    <option value="take_attandance.php?course_id=<?php echo $course_id ?>&section=<?php echo $section_id?>"><?php echo $course_code." section-".$section?></option>
                  <?php } ?>
               </select>
            </section>
          </div>
